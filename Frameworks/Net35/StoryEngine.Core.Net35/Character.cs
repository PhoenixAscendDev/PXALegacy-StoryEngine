    ...
    public abstract class Character : ICharacter<string>
    {
        ...
        public virtual Body<string> Body
        {
            ...
            set
            {
                ...
                _bodyparts[Enum.BodyPartType.Foot] = (IEnumerable < IBodyPart<string> > )value.Feet;
                _bodyparts[Enum.BodyPartType.Hand] = (IEnumerable < IBodyPart<string> > )value.Hands;
                _bodyparts[Enum.BodyPartType.Head] = (IEnumerable < IBodyPart<string> > )value.Heads;
        ...
        public virtual IEnumerable<IFoot<string>> Feet
        {
            ...
            set
            {
                _bodyparts[Enum.BodyPartType.Foot] = (IEnumerable<IBodyPart<string>>)value;
            }
        }
        ...
        public virtual IEnumerable<IHand<string>> Hands
        {
            ...
            set
            {
                _bodyparts[Enum.BodyPartType.Hand] = (IEnumerable<IBodyPart<string>>)value;
            }
        }
        ...
        public virtual IEnumerable<IHead<string>> Heads
        {
            ...
            set
            {
                _bodyparts[Enum.BodyPartType.Head] = (IEnumerable<IBodyPart<string>>)value;
            }
        }
