...
namespace JB2.Storybook
{
    public  class Human : Character,ISpecies<string>
    {
        ...
        public Human() : base()
        {
            _bodyparts.Add(Storybook.Enum.BodyPartType.Head, new Head[1] { new Head() });
            _bodyparts.Add(Storybook.Enum.BodyPartType.Hand, new Hand[2] { new Hand(5), new Hand(5) });
            _bodyparts.Add(Storybook.Enum.BodyPartType.Foot, new Foot[2] { new Foot(5), new Foot(5) });
        }
